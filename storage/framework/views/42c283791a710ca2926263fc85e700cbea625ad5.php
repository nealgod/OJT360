        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-bold text-ojt-dark mb-2">
                            <?php echo e(ucfirst($profile?->ojt_status ?? 'Pending')); ?>

                        </p>
                        <p class="text-sm text-gray-600">
                            <?php if($profile?->ojt_status === 'active'): ?>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-xl p-4 min-w-[140px]">
                            ...
                            <p class="text-3xl font-bold text-green-900"><?php echo e(number_format($completedHours, 1)); ?></p>
                ...
                <?php if($requiredHours > 0): ?>
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm font-bold text-ojt-primary"><?php echo e($percentage); ?>%</span>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-2">
                                <p class="text-sm text-gray-600 flex items-start">
                                    ...
                                    <span><?php echo e($company->address ?? 'Address not set'); ?></span>
                                </p>
                                <?php if($acceptance?->start_date): ?>
                                    <p class="text-sm text-gray-600 flex items-center">
                                        <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        Started <?php echo e($acceptance->start_date->format('M d, Y')); ?>

                                    </p>
                                <?php endif; ?>
                                <?php if($company?->department): ?>
                                    <p class="text-sm text-gray-600 flex items-center">
                                        <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                    ...
                    <?php if($supervisor): ?>
                        <div class="flex items-start space-x-4">
                            <?php if($supervisor->supervisorProfile?->profile_image): ?>
                                <img src="<?php echo e(Storage::url($supervisor->supervisorProfile->profile_image)); ?>" 
                                     alt="<?php echo e($supervisor->name); ?>" 
                                     class="w-16 h-16 rounded-full object-cover border-2 border-ojt-primary flex-shrink-0">
                            <?php else: ?>
                                <div class="w-16 h-16 <?php echo e($supervisor->getAvatarColor()); ?> rounded-full flex items-center justify-center text-white text-xl font-bold flex-shrink-0">
                                    <?php echo e(substr($supervisor->name, 0, 1)); ?>

                                </div>
                            <?php endif; ?>
                            <div class="space-y-2 flex-1">
                                <p class="text-xl font-semibold text-ojt-dark"><?php echo e($supervisor->name); ?></p>
                                <?php if($supervisor->supervisorProfile?->position): ?>
                                    <p class="text-sm text-gray-500"><?php echo e($supervisor->supervisorProfile->position); ?></p>
                                <?php endif; ?>
                                <div class="space-y-1">
                                    <p class="text-sm text-gray-600 flex items-center">
                                        <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <?php if($supervisor->supervisorProfile?->phone): ?>
                                        <p class="text-sm text-gray-600 flex items-center">
                                            <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                            </svg>
                                            <?php echo e($supervisor->supervisorProfile->phone); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <?php if($acceptance && $acceptance->work_schedule): ?>
                        <?php
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-700">
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-base font-medium"><?php echo e(isset($schedule['shift_start']) ? $formatTime($schedule['shift_start']) : '—'); ?> – <?php echo e(isset($schedule['shift_end']) ? $formatTime($schedule['shift_end']) : '—'); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs uppercase tracking-wide text-gray-500 mb-1">Break Time</p>
                                    <p class="text-base font-medium">
                                        <?php if(isset($schedule['break_minutes']) && $schedule['break_minutes'] > 0): ?>
                                            <?php
                                            ...
                                            <?php if($hours > 0 && $mins > 0): ?>
                                                <?php echo e($hours); ?> <?php echo e($hours == 1 ? 'hour' : 'hours'); ?> <?php echo e($mins); ?> <?php echo e($mins == 1 ? 'minute' : 'minutes'); ?>

                                            <?php elseif($hours > 0): ?>
                                                <?php echo e($hours); ?> <?php echo e($hours == 1 ? 'hour' : 'hours'); ?>

                                            <?php else: ?>
                                                <?php echo e($mins); ?> <?php echo e($mins == 1 ? 'minute' : 'minutes'); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-base font-medium"><?php echo e($acceptance->total_hours ?? 'Not specified'); ?> hours</p>
                                </div>
                            </div>
                            <div>
...
<?php /**PATH C:\xampp\htdocs\ojt360\resources\views/students/placement.blade.php ENDPATH**/ ?>