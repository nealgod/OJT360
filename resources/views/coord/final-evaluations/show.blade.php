    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('coordinator.final-evaluations.download-pdf', ['evaluation' => $evaluation->id, 'view' => 1]) }}" target="_blank"
                ...
                <a href="{{ route('coordinator.final-evaluations.index') }}" 
                ...
                <div class="space-y-6">
                    ...
                    @if(!$evaluation->reviewed_at)
                        <div class="bg-white rounded-lg border border-gray-200 p-6">
                            ...
                            <form action="{{ route('coordinator.final-evaluations.mark-reviewed', $evaluation) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <button type="submit" 
