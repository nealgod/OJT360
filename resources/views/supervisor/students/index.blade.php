                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <div class="w-full sm:w-auto">
                            <select id="statusFilter" 
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ojt-primary focus:border-ojt-primary transition-colors">
                ...
                <div id="studentsList" class="space-y-4">
                    @foreach ($students as $student)
                        ...
                        <div class="student-card bg-white border border-gray-200 rounded-lg p-5 shadow-sm hover:border-ojt-primary/50 transition-colors" 
                             ...
                             data-status="{{ $profile?->ojt_status ?? 'active' }}">
        ...
        function filterStudents() {
            ...
            cards.forEach(card => {
                ...
                if (statusFilter === 'active') {
                    matchesStatus = status === 'active' || status === 'pending';
